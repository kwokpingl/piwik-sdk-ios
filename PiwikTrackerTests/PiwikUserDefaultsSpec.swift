...
class PiwikUserDefaultsSpec: QuickSpec {
    override func spec() {
        describe("suiteMigration") {
            it("should migrate data for the default suite") {
                ...
                var userDefaults = PiwikUserDefaults(suiteName: "_specSuite")
    ...
    private func setMigrateableData(totalNumberOfVisists: Int, firstVisit: Date?, previousVisit: Date?, currentVisit: Date?, optOut: Bool, clientId: String?) {
        UserDefaults.standard.set(totalNumberOfVisists, forKey: PiwikUserDefaults.Key.totalNumberOfVisits)
        UserDefaults.standard.set(firstVisit, forKey: PiwikUserDefaults.Key.firstVistsTimestamp)
        UserDefaults.standard.set(previousVisit, forKey: PiwikUserDefaults.Key.previousVistsTimestamp)
        UserDefaults.standard.set(currentVisit, forKey: PiwikUserDefaults.Key.currentVisitTimestamp)
        UserDefaults.standard.set(optOut, forKey: PiwikUserDefaults.Key.optOut)
        UserDefaults.standard.set(clientId, forKey: PiwikUserDefaults.Key.visitorID)
    }
}
